...
const ContactForm: React.FC = () => {
  ...
  return (
    <section id="contact-form" className="mx-auto flex max-w-5xl flex-col p-2">
      <span className="mx-auto text-6xl"> Contact Us </span>
      <div className="flex w-full flex-col lg:flex-row ">
        ...
        <div className="flex w-full flex-col bg-blue-300 lg:ml-2">
          <div className="h-1 w-full bg-[#CC0007]" />
          <form onSubmit={form.onSubmit(console.log)} className="flex flex-col">
            <TextInput
              label="Name"
              placeholder="Name"
              withAsterisk
