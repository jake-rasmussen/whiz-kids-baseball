        ...
        <div className="flex grow justify-end md:hidden">
          <div className="flex flex-col items-center justify-center">
            <div className="dropdown-end dropdown">
              ...
              <ul
                tabIndex={0}
                className="dropdown-content menu rounded-box mt-4 w-52 bg-base-100 p-4 text-xl shadow"
              >
                <li className="text-3xl font-extrabold text-dark-gray hover:text-red">
                  <a>Home</a>
                </li>
                <li className="text-3xl font-extrabold text-dark-gray hover:text-red">
                  <a>Teams</a>
