...
const Home: NextPageWithLayout = () => {
  ...
  return (
    <>
      <Toaster />
      <main className="h-[40rem] lg:h-screen w-full bg-dark-gray">
        <div className="fixed flex h-[40rem] lg:h-screen min-w-full flex-col items-center justify-center overflow-hidden">
