...
const Home: NextPageWithLayout = () => {
  ...
  return (
    <>
      <Toaster />
      <main className="h-[40rem] lg:h-adjusted w-full bg-dark-gray">
        <div className="flex h-[40rem] lg:h-full min-w-full flex-col items-center justify-center overflow-hidden">
